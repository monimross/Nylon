...
import { images, SaleIcon, StockIcon } from "../../../constants/images";
    ...
    <div className="product-data">
      ...
      <div className="add-review">
        ...
        {product.reviews.length > 0 ? (
          ...
          <Empty image={images.ViewedProduct} text1="Reviews not found" />
        )}
      </div>
    </div>
  );
