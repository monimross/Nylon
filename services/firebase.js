...
const firebaseConfig = {
  apiKey: config?.api_key ? config?.api_key : process.env.API_KEY,
  authDomain: config?.auth_domain
    ? config?.auth_domain
    : process.env.AUTH_DOMAIN,
  projectId: config?.project_id ? config?.project_id : process.env.PROJECT_ID,
  ...
  appId: config?.app_id ? config?.app_id : process.env.APP_ID,
